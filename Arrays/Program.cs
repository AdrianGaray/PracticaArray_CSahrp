...
namespace Arrays
{
    class Program
    {
        ...
        {
            // Declaracion de arreglos 1
            Console.ForegroundColor = ConsoleColor.Red;
            int[] array1 = new int[3];
            array1[0] = 100;
            array1[1] = 200;
            Console.WriteLine($"array[0] = {array1[0]} y array1[1] = {array1[1]}");
            Console.ReadKey();
            ...
            Console.WriteLine($"El estudiente 1 del grupo 1 tiene una nota de {studentScores[0,0]}");
            Console.WriteLine($"El estudiente 1 del grupo 2 tiene una nota de {studentScores[1,0]}");
